...
const schema = yup.object({
    ...
    telephone: yup.string().required("Telephone is a required field.").matches(/^[\s.-]\d{3}[\s.-]{3}[\s.-]\d{4}$/, "Phone number must match the form 000 000 0000"),
        ...
        <form onSubmit={handleSubmit(formSubmit)}>
            <fieldset>
                ...
                <div className="field">
                    ...
                    <input type="text" placeholder="text@email.com" name="email" {...register("name")} />
                ...
                <div className="field guest">
                    ...
                    <input type="number" placeholder="2" name="guests" {...register("guests")}> </input>
                    <span className="error-message">{errors.guests?.message}</span>
                </div>
                <div className="field">
                    <label htmlFor="date">Date & Time</label>
                    <input type="datetime-local" name="date" {...register("date")}></input>
